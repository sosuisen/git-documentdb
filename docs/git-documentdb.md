...
|  --- | --- |
|  [AcceptedConflicts](./git-documentdb.acceptedconflicts.md) | Accepted Conflicts<!-- -->This shows which stage is accepted when a conflict occurs. |
...
|  [FileChanges](./git-documentdb.filechanges.md) | Changed files in merge |
