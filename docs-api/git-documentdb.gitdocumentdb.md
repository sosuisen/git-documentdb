...
|  [findFatDoc(options)](./git-documentdb.gitdocumentdb.findfatdoc.md) |  | Get all the data |
...
|  [getCommit(oid)](./git-documentdb.gitdocumentdb.getcommit.md) |  | Get commit object |
|  [getDocByOid(fileOid, docType)](./git-documentdb.gitdocumentdb.getdocbyoid.md) |  | Get a Doc which has specified oid |
|  [getFatDoc(name, getOptions)](./git-documentdb.gitdocumentdb.getfatdoc.md) |  | Get a FatDoc |
|  [getFatDocBackNumber(name, backNumber, historyOptions, getOptions)](./git-documentdb.gitdocumentdb.getfatdocbacknumber.md) |  | Get a back number of a data |
|  [getFatDocHistory(name, historyOptions, getOptions)](./git-documentdb.gitdocumentdb.getfatdochistory.md) |  | Get revision history of a data |
...
|  [putFatDoc(name, doc, options)](./git-documentdb.gitdocumentdb.putfatdoc.md) |  | Insert a data if not exists. Otherwise, update it. |
