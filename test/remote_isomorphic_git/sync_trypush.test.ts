...
const reposPrefix = 'test_sync_trypush_isomorphic-git___';
const localDir = `./test/database_sync_trypush_isomorphic-git`;
...
maybe('isomorphic-git', syncTryPushBase(connection, remoteURLBase, reposPrefix, localDir));
