...
const reposPrefix = 'test_3way_merge_isomorphic_git__';
const localDir = `./test/database_3way_merge_isomorphic_git`;
...
maybe(
  ...
  syncThreeWayMergeBase(connection, remoteURLBase, reposPrefix, localDir)
);
