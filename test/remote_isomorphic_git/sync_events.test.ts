...
const reposPrefix = 'test_sync_events_isomorphic_git___';
const localDir = `./test/database_sync_events_isomorphic_git`;
...
maybe(
  ...
  syncEventsBase(connection, remoteURLBase, reposPrefix, localDir)
);
