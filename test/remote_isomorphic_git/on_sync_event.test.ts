...
import { onSyncEventBase } from '../remote_base/on_sync_event';
import { ConnectionSettingsGitHub } from '../../src/types';

const reposPrefix = 'test_on_sync_event_isomorphic_git__';
...
maybe('isomorphic-git', onSyncEventBase(connection, remoteURLBase, reposPrefix, localDir));
