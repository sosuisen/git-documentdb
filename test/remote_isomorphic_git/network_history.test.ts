...
const reposPrefix = 'test_network_history_isomorphic_git__';
const localDir = `./test/database_network_history_isomorphic_git`;
...
maybe(
  'isomorphic-git',
  networkHistoryBase(connection, remoteURLBase, reposPrefix, localDir)
);
