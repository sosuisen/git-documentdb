...
const reposPrefix = 'test_combine_isomorphic_git__';
const localDir = `./test/database_combine_isomorphic_git`;
...
maybe('isomorphic-git', syncCombineBase(connection, remoteURLBase, reposPrefix, localDir));
