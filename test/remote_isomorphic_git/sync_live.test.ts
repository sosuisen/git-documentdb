...
const reposPrefix = 'test_sync_live_isomorphic_git___';
const localDir = `./test/database_sync_live_isomorphic_git`;
...
maybe('isomorphic-git', syncLiveBase(connection, remoteURLBase, reposPrefix, localDir));
