...
const reposPrefix = 'test_sync_trysync_isomorphic_git___';
const localDir = `./test/database_sync_trysync_isomorphic_git`;
...
maybe('isomorphic-git', syncTrySyncBase(connection, remoteURLBase, reposPrefix, localDir));
