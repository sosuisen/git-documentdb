...
describe('<collection>', () => {
  ...
  describe('find()', () => {
    ...
    it('returns docs by breadth-first search (recursive)', async () => {
      ...
      await addOneData(
        gitDDB,
        col.collectionPath + _id_b + JSON_POSTFIX,
        toSortedJSONString(json_b)
      );
      await addOneData(
        gitDDB,
        col.collectionPath + _id_a + JSON_POSTFIX,
        toSortedJSONString(json_a)
      );
      await addOneData(
        gitDDB,
        col.collectionPath + _id_d + JSON_POSTFIX,
        toSortedJSONString(json_d)
      );
      await addOneData(
        gitDDB,
        col.collectionPath + _id_c01 + JSON_POSTFIX,
        toSortedJSONString(json_c01)
      );
      await addOneData(
        gitDDB,
        col.collectionPath + _id_c02 + JSON_POSTFIX,
    ...
    describe('Prefix search', () => {
      it('gets from directory', async () => {
        ...
        await addOneData(
          gitDDB,
          col.collectionPath + _id_c000 + JSON_POSTFIX,
          toSortedJSONString(json_c000)
        );
        await addOneData(
          gitDDB,
          col.collectionPath + _id_c001 + JSON_POSTFIX,
      ...
      it('gets from deep directory', async () => {
        ...
        await addOneData(
          gitDDB,
          col.collectionPath + _id_p + JSON_POSTFIX,
